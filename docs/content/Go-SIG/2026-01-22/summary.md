...
- Updates on the stabilization of the OTel HTTP and related components, with an emphasis on community contributions during member absences.
...
- Damien to seek community input on the deprecation of duplicate metric attribute settings in OTel HTTP.
