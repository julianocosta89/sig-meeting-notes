...
- Q: When can we release the new version of OTel Swift with the bug fixes?
  - Release PR 2.6.0 started (core)
- Session PR todo:
  - [https://github.com/open-telemetry/opentelemetry-swift/pull/1184](https://github.com/open-telemetry/opentelemetry-swift/pull/1184)
- (Yasura) HTTP Metric exporter bug fix PRs
...
- Adding iOS specific instrumentation is a-ok.
